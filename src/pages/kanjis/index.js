                    ...
                    <div className="flex flex-col items-center md:mt-14 mx-auto">
                        ...
                        <div className="relative mt-10">
                            <form onSubmit={onSearch}>
                                <input
                                    className="text-2xl search-input w-full border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg focus:outline-none"
                                    type="search"
                                    name="search"
                                ...
                                <button
                                    type="submit"
                                    className="search-btn-icon mt-5 mr-4"
                                >
                                    <svg
                                        className="absolute right-0 magnifier"
