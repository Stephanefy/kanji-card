...
const KisetsuModeToggle = () => {
    const [isHaru, setIsHaru] = useState(
        localStorage.getItem('theme') === 'haru' ? true : false
    )
    const [isNatsu, setIsNatsu] = useState(
        localStorage.getItem('theme') === 'natsu' ? true : false
    )
    const [isAki, setIsAki] = useState(
        localStorage.getItem('theme') === 'aki' ? true : false
    )
    const [isFuyu, setIsFuyu] = useState(
        localStorage.getItem('theme') === 'aki' ? true : false
    )
            ...
            <div className="flex flex-col">
                <div className="switch-parent">
                    <label className="switch">
                        ...
                        />
                        <span className="switch-kanji font-bold text-white">
                            春
                        </span>
