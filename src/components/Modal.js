...
const Modal = ({ setIsOpen, selectedKanji }) => {
  ...
  return (
    <div 
        class="min-h-screen w-full py-6 flex flex-col justify-center sm:py-12 absolute z-10" 
        ...
        {!kanji ? (
            ...
            <div class="py-3 w-4/12 sm:max-w-xl sm:mx-auto">
                <div class="bg-white min-w-1xl flex flex-col rounded-xl shadow-lg">
                <div class="px-12 py-5">
                    <h2 class="text-gray-800 text-3xl font-semibold text-4xl flex justify-center">{kanji.grade}e année</h2>
                </div>
                <div class="bg-gray-200 w-full flex flex-col items-center">
                    <div class="flex flex-col items-center py-6 space-y-3">
                    <span class="text-lg text-gray-800 text-6xl">{kanji.kanji}</span>
                    </div>
